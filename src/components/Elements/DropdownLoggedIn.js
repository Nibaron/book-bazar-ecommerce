...
export const DropdownLoggedIn = ({setDropdown}) => {
    ...
    return (
        ...
        >
            ...
            <div className="py-1">
                <span onClick={handleDropdownLoggedIn} className="cursor-pointer block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                    Log out
                </span>
            </div>
        </div>
